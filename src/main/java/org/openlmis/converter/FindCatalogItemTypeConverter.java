...
@Component
public class FindCatalogItemTypeConverter extends BaseTypeConverter {
  ...
  public boolean supports(String type) {
    return "FIND_CATALOG_ITEM".equalsIgnoreCase(type);
  }

  @Override
  public void convert(JsonObjectBuilder builder, Mapping mapping, String value) {
    findItem(value).ifPresent(itemId -> builder.add(mapping.getTo(), itemId));
  }

  private Optional<String> findItem(String key) {
