...
@Component
class DefaultIdTypeConverter extends BaseTypeConverter {
  ...
  public boolean supports(String type) {
    return startsWithIgnoreCase(type, "DEFAULT_TO_ID_BY");
  }
