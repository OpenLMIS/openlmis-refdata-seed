...
public class JsonObjectComparisonUtils {
   ...
   * object.
   * An example that requires this logic can be found in identifiers of Orderable. There is the
   * assumption that an Orderable can have one identifier attached, so this logic allows to
